...
public class SentinelFilterConfiguration {
    ...
    public SentinelFilterConfiguration(ObjectProvider<List<ViewResolver>> viewResolvers, ServerCodecConfigurer codecConfigurer) {
    ...
    public SentinelGatewayBlockExceptionHandler sentinelGatewayBlockExceptionHandler() {
        return new SentinelGatewayBlockExceptionHandler(viewResolvers, codecConfigurer);
    }
